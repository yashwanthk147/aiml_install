        ...
        stage('Install Python and Setup Environment') {
            steps {
                sshagent(['terraform_id']) {
                    ...
                    sh "ssh -o StrictHostKeyChecking=no ubuntu@${params.SERVER_IP} 'sudo rm -rf /home/ubuntu/*'"
                    ...
                    sh "ssh -o StrictHostKeyChecking=no ubuntu@${params.SERVER_IP} 'chmod +x ${apppath}/python_aiml.sh  && ./python_aiml.sh ${params.PYTHON_VERSION} ${params.VENV_NAME} ${params.Domainname}'"
